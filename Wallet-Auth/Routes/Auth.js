  ...
  if (number) {
    Otp.deleteMany({ number })
      ...
      .then(() => {
        ...
        smsMessage.body = `<#> Rpay never calls you asking for otp. Sharing it with anyone gives them full access to your Rpay wallet. Your Login OTP is ${otpNumber} . ID: uPxbwGuwMaB`;
